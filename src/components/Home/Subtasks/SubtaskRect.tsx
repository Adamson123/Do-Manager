...
const SubtaskRect = ({
  ...
  const toggleCompletion = () => {
    const toggledSubtask = {
      ...
      sideUpdate: "completion" as const,
      userId,
    };
  ...
  const handleEditSubtask = () => {
    ...
    triggerEditSubtask({
      task: { title, description, dueDate, taskId, userId: "" },
      id,
      exec: "edit",
    });
  };
...
export default memo(SubtaskRect, (prevProps, nextProps) => {
  return (
    ...
    prevProps.triggerEditSubtask === nextProps.triggerEditSubtask
  );
});
